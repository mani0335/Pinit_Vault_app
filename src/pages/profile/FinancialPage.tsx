...
const ITEMS = [
  { id: 'bank-stmt', title: 'Bank Statements', icon: '🏦', description: 'Latest bank account statements', methods: ['camera', 'upload'] },
  { id: 'itr', title: "ITR's", icon: '📋', description: 'Income Tax Return filed documents', methods: ['camera', 'upload'] },
  { id: 'affidavit', title: 'Affidavits', icon: '⚖️', description: 'Notarized affidavit documents', methods: ['camera', 'upload'] }
];

export default function FinancialPage({ categoryTitle = 'Financial', categoryEmoji = '💰', onBack }: any) {
