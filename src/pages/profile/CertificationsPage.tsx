...
const ITEMS = [
  { id: 'online-courses', title: 'Online Courses', icon: '📚', description: 'Certificates from Coursera, Udemy, etc.', methods: ['camera', 'upload'] },
  { id: 'workshops', title: 'Workshops', icon: '🛠️', description: 'Workshop participation certificates', methods: ['camera', 'upload'] },
  { id: 'hackathons', title: 'Hackathons', icon: '🏆', description: 'Hackathon participation/winning certificates', methods: ['camera', 'upload'] }
];
