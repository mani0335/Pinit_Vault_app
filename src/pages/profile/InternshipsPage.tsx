...
const ITEMS = [
  { id: 'offer-letter', title: 'Offer Letter', icon: '📮', description: 'Internship offer document', methods: ['camera', 'upload'] },
  { id: 'completion-cert', title: 'Completion Certificate', icon: '🎖️', description: 'Internship completion proof', methods: ['camera', 'upload'] },
  { id: 'work-proof', title: 'Work Proof Images', icon: '📷', description: 'Photos from work experience', methods: ['camera', 'upload'] }
];

export default function InternshipsPage({ categoryTitle = 'Internships', categoryEmoji = '💼', onBack }: any) {
